...
5. When starting from `main`, create a `<feature-slug>` branch if the working tree can be carried safely. If existing changes make branch ownership unclear, stop and ask for direction.
